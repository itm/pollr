...
public class MessageBox implements MessageBoxView.Presenter {
    ...
    public static void error(final String title, final String message, final String stacktrace, final Callback callback) {
        final MessageBox messageBox = INJECTOR.getMessageBox();
        messageBox.setTitle(title);
        messageBox.setMessage(message);
        ...
        messageBox.setButtons(Button.OK);
        messageBox.setCallback(callback);
        messageBox.setStacktrace(stacktrace);
