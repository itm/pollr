...
public interface PollService {
     ...
     */
    XoPoll addPoll(XoPoll poll) throws RemoteException;
     ...
     */
    List<XoPoll> getPolls() throws RemoteException;
     ...
     */
    XoPoll getPoll(Integer pollId) throws RemoteException;
     ...
     */
    void removePoll(Integer pollId, String adminUuid) throws RemoteException;
     ...
     */
    XoVote addVote(XoVote vote) throws RemoteException;
     ...
     */
    List<XoVote> getVotes(Integer optionId) throws RemoteException;
     ...
     */
    XoOption getMostPopularOption(Integer pollId, Integer optionListId) throws RemoteException, PollException;
     ...
     */
    List<XoPollInfo> getPollInfos(boolean onlyValidPublic) throws RemoteException;
     ...
     */
    void removeVote(Integer voteId, String adminUuid) throws RemoteException;
     ...
     * @return The <code>XoPoll</code> object
     */
    XoPoll getPoll(String uuid) throws RemoteException;
     ...
     * @throws RemoteException
     */
    List<XoPollInfo> findPoll(String name) throws RemoteException;

    /**
     * @param optionListId
     * @return
     */
    Map<String, List<XoVote>> getVotesForOptionList(Integer optionListId) throws RemoteException;
}
